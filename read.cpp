...
std::ifstream readTrainingImgHeader(int &magic_num, int &num_img, int &num_row, int &num_col) {
	std::ifstream training_images_file("C:/Users/Nikita/OneDrive/Documents/GitHub/DNN/Data/train-images.idx3-ubyte", std::ios::binary);
...
std::ifstream readTestingImgHeader(int &magic_num, int &num_img, int &num_row, int &num_col) {
	std::ifstream testing_images_file("C:/Users/Nikita/OneDrive/Documents/GitHub/DNN/Data/t10k-images.idx3-ubyte", std::ios::binary);
...
std::ifstream readTrainingLblHeader(int &magic_num, int &num_img) {
	std::ifstream training_labels_file("C:/Users/Nikita/OneDrive/Documents/GitHub/DNN/Data/train-labels.idx1-ubyte", std::ios::binary);
...
std::ifstream readTestingLblHeader(int &magic_num, int &num_img) {
	std::ifstream testing_labels_file("C:/Users/Nikita/OneDrive/Documents/GitHub/DNN/Data/t10k-labels.idx1-ubyte", std::ios::binary);
